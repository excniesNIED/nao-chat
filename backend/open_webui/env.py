...
WEBUI_NAME = os.environ.get("WEBUI_NAME", "NAO Chat")
if WEBUI_NAME != "NAO Chat":
    WEBUI_NAME += " (NAO Chat)"

WEBUI_FAVICON_URL = "https://gastigado.cnies.org/d/nao/favicon.png?sign=M1lDDrOct7BJRDEV6TUNY82JZC7EsPhkVjFT-O7FLe8=:0"
